    ...
    <div className="mx-auto max-w-7xl px-5 pb-20 pt-10 md:px-8 md:pt-14">
      <Reveal as="section" className="grid gap-10 md:grid-cols-2" threshold={0.1}>
        <div>
          ...
          />
          <p className="mt-7 text-lg leading-relaxed text-charcoal/80">
        ...
        <div className="relative min-h-[340px] md:min-h-[420px]">
          ...
          />
          <div className="organic-shape absolute -bottom-5 -left-4 h-24 w-24 bg-roseclay/50" aria-hidden="true" />
        </div>
      </Reveal>
      ...
      <Reveal as="section" className="mt-16 grid gap-5 md:grid-cols-3" delay={170} duration={840}>
        {[
          ...
          <article key={item.title} className="soft-card rounded-3xl border border-walnut/10 p-7 shadow-soft">
      ...
      <Reveal as="section" className="mt-14 grid gap-6 rounded-[2rem] bg-cream/70 p-6 md:grid-cols-2 md:p-8" delay={260} duration={860}>
